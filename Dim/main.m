...
static struct option long_options[] = {
    ...
    {"generate-iconset",          no_argument,          &generateIconset,   'i'},
    {"optimize-images",           no_argument,          &optimizeImages,    'o'},
    {"force",                     no_argument,          &overwrite,         'f'},
...
int main(int argc, const char * argv[]) {@autoreleasepool {
    ...
    NSString *extension = generateIconset ? @"iconset" : @"icns";
    NSString *fileName = [NSString stringWithFormat:@"%@-Document.%@", name, extension];
    ...
    if (exists && isFolder && ![destination hasSuffix:extension]) {
        destination = [NSString stringWithFormat:@"%@/%@", destination, fileName];
    }
